...
<head>
    ...
    <title>Välkommen till Motion Master</title>
    <style>
        * {
...
<body>
    <div class="email-container">
        <h1>Välkommen till Motion Master - bekräfta din e-postadress</h1>
        <p>Hej {{ $name }},</p>
        <p>Välkommen till Motion Master! Vi är glada att du har valt att bli medlem hos oss.</p>
        ...
        <p>Med vänliga hälsningar,<br>Motion Master</p>
    </div>
</body>
</html>